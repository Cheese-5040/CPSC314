...
postScene.add( postQuad ); //a plane (quad) that fills the whole screen, can use to render an image as well
...
function update() {
  ...
  else
  {
    ...
    renderer.render( postScene, postCam ); //render to post scene 
  }
  renderer.setRenderTarget(renderTarget1);
  renderer.clear();
}
