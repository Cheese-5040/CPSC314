...
var worldFrame = new THREE.AxesHelper(5) ; //adding the axis, RGB -> XYZ
...
var earthColorTexture = 
    ...
    //bumpmap means shows the height field of all the bumps in the earth 
...
controls.damping = 0.2; //for mouse to move around
